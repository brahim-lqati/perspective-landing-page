...
function Products() {
  const data = [
    ...
    {
      name: "Perception Writer",
      desc: "Perception Writing is a pen that allows its user to overcome his disability and get even more autonomy and independence through a pen plotter.",
